...
public:
    enum GMLLaneChangeMode {
        ...
        GML_EXT_TRACI_ONLY_BY_SPEED = 0x02 << 8,
        GML_EXT_TRACI_NATURAL = 0x03 << 8,
        ...
        GML_DISALLOW_OVERTAKE = GML_FORCE_STRATEGIC | GML_FORCE_COOPERATIVE | GML_NO_SPEED_GAIN | GML_NO_DRIVE_ON_RIGHT
